...
import logo from '../../../Images/BrainTumorDetector1.png';
import './Header.css';
        ...
        <div className="head-bg">
            <Navbar className="navbar" collapseOnSelect expand="lg">
                <Container className="container-head">
                    <Navbar.Brand href="/home"><img src={logo} alt="logo" />   Brain Tumor Detector</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto align-items-center">
                            ...
                            <Link to="/service" className='list-item text-decoration-none'>FAQs</Link>
                            <Link to="/dentist" className='list-item text-decoration-none'>Symptoms</Link>
